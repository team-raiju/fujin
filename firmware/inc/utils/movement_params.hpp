...
extern std::map<Movement, TurnParams> turn_params_super;
extern std::map<Movement, ForwardParams> forward_params_super;
...
extern GeneralParams general_params_super;
