...
static std::map<Movement, TurnParams> turn_params_slow = {
    {Movement::TURN_RIGHT_45, {-5.8, -7.8, 0.5, 100.00, 7.854, 0.7679, -1}},
    {Movement::TURN_LEFT_45, {-5.8, -7.8, 0.5, 100.00, 7.854, 0.7679, 1}},
    ...
    {Movement::TURN_LEFT_135, {-0.5, -7.4, 0.5, 100.00, 7.5049, 2.3387, 1}},

    {Movement::TURN_RIGHT_45_FROM_45, {0.0, 4.35, 0.5, 100.0, 7.8539, 0.7679, -1}},
    {Movement::TURN_LEFT_45_FROM_45, {0.0, 4.35, 0.5, 100.0, 7.8539, 0.7679, 1}},
    {Movement::TURN_RIGHT_90_FROM_45, {0.0, -4.7, 0.5, 104.72, 10.47, 1.553, -1}},
    {Movement::TURN_LEFT_90_FROM_45, {0.0, -5.4, 0.5, 104.72, 10.47, 1.553, 1}},
    {Movement::TURN_RIGHT_135_FROM_45, {0.0, 0.1, 0.5, 100.0, 7.5049, 2.3387, -1}},
...
static std::map<Movement, ForwardParams> forward_params_slow = {
    ...
    {Movement::TURN_RIGHT_45_FROM_45, {0.5, 2.0, 2.0, 8.0}},
    {Movement::TURN_LEFT_45_FROM_45, {0.5, 2.0, 2.0, 8.0}},
    {Movement::TURN_RIGHT_90_FROM_45, {0.5, 2.0, 2.0, 5.4}},
    {Movement::TURN_LEFT_90_FROM_45, {0.5, 2.0, 2.0, 5.4}},
