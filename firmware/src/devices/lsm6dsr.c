...
/** @defgroup LSM6DSR_Private_Function_Prototypes LSM6DSR Private Function
 * Prototypes
 * @{
 */
...
int32_t LSM6DSR_ACC_SetFullScale(LSM6DSR_Object_t *pObj, int32_t FullScale)
{
   ...
   statical analysis point of view because the parameter passed to the function
...
/**
 * @brief  Get the LSM6DSR FIFO accelero single sample (16-bit data per 3 axes)
 * and calculate acceleration [mg]
 * @param  pObj the device pObj
...
/**
 * @brief  Get the LSM6DSR FIFO gyro single sample (16-bit data per 3 axes) and
 * calculate angular velocity [mDPS]
 * @param  pObj the device pObj
